...
async function deployEscrowFactory(chainName: keyof typeof testnetConfig.chains) {
    ...
    const factory = new ethers.ContractFactory(factoryContract.abi, factoryContract.bytecode, deployer);
...
async function main() {
    ...
    if (!chainName) {
        console.log('Usage: CHAIN_NAME=<chainName> ts-node scripts/deploy-escrow-factory.ts');
        console.log('Available chains:', Object.keys(testnetConfig.chains).join(', '));
        console.log('\nExample:');
        console.log('  CHAIN_NAME=sepolia ts-node scripts/deploy-escrow-factory.ts');
        console.log('  CHAIN_NAME=arbTestnet ts-node scripts/deploy-escrow-factory.ts');
        console.log('\nOr use yarn scripts:');
