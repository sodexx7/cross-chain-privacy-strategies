...
export const TRUE_ERC20 = {
    ...
    // Testnet chains
    [NetworkEnum.ETHEREUM_SEPOLIA]: new Address(
        testnetConfig.chains.sepolia.wrappedNative
    ),
    [NetworkEnum.ARBITRUM_SEPOLIA]: new Address(
        testnetConfig.chains.arbTestnet.wrappedNative
    )
}
...
export const ESCROW_SRC_IMPLEMENTATION = {
    ...
    // Testnet chains
    [NetworkEnum.ETHEREUM_SEPOLIA]: new Address(
        testnetConfig.chains.sepolia.resolver
    ),
    [NetworkEnum.ARBITRUM_SEPOLIA]: new Address(
        testnetConfig.chains.arbTestnet.resolver
    )
}
...
export const ESCROW_FACTORY = {
    ...
    // Testnet chains
    [NetworkEnum.ETHEREUM_SEPOLIA]: new Address(
        testnetConfig.chains.sepolia.escrowFactory
    ),
    [NetworkEnum.ARBITRUM_SEPOLIA]: new Address(
        testnetConfig.chains.arbTestnet.escrowFactory
    )
}
