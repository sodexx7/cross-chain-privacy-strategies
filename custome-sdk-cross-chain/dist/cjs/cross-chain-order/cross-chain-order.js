...
exports.CrossChainOrder = void 0;
...
class CrossChainOrder {
    ...
    static new(escrowFactory, orderInfo, escrowParams, details, extra) {
        const postInteractionData = fusion_sdk_1.SettlementPostInteractionData.new({
            ...
            resolvingStartTime: details.resolvingStartTime ?? (0, fusion_sdk_1.now)(),
            customReceiver: orderInfo.receiver
        });
        const ext = new escrow_extension_1.EscrowExtension(escrowFactory, details.auction, postInteractionData, extra?.permit
            ? new fusion_sdk_1.Interaction(orderInfo.makerAsset, extra.permit)
    ...
    static fromDataAndExtension(order, extension) {
        ...
        return new CrossChainOrder(ext, {
            makerAsset: new fusion_sdk_1.Address(order.makerAsset),
            takerAsset: new fusion_sdk_1.Address(order.takerAsset),
            makingAmount: BigInt(order.makingAmount),
            takingAmount: BigInt(order.takingAmount),
            receiver: new fusion_sdk_1.Address(order.receiver),
            maker: new fusion_sdk_1.Address(order.maker),
     ...
     */
    isExclusivityPeriod(time = (0, fusion_sdk_1.now)()) {
    ...
    getMultipleFillIdx(fillAmount, remainingAmount = this.makingAmount) {
        (0, assert_1.default)(this.inner.multipleFillsAllowed, 'Multiple fills disabled for order');
...
exports.CrossChainOrder = CrossChainOrder;
