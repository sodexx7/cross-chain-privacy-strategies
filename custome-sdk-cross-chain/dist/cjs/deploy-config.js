...
const ConfigSchema = zod_1.z.object({
    DEPLOYER_PRIVATE_KEY: zod_1.z.string().min(1),
    USER_PRIVATE_KEY: zod_1.z.string().min(1),
    RESOLVER_PRIVATE_KEY: zod_1.z.string().min(1),
    ETHEREUM_SEPOLIA_RPC_URL: zod_1.z.string().url(),
    ARBITRUM_SEPOLIA_RPC_URL: zod_1.z.string().url()
});
